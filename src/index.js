    ...
    const initializeAccountButtons = () => {
        ...
        createToken.onclick = async () => {
            ...
            try {
                ...
                transferTokensWithoutGas.onclick = async () => {
                    ...
                    const result = await contract.transferFrom("0x1843A939891268f767CdB398550bDEbCb01055CA", '0x2551033F68bD83f50049A37BFC59E39fbAB762E4', '10000', {
                        gasPrice: '20000000000',
                    })
                    console.log('result', result)
                }
                ...
                approveTokensWithoutGas.onclick = async () => {
                    const result = await contract.approve('0x2551033F68bD83f50049A37BFC59E39fbAB762E4', '10000', {
                        gasPrice: '20000000000',
                    })
                    console.log(result)
                }
        ...
        getAccountsButton.onclick = async () => {
            try {
                ...
                getAccountsBalance.innerHTML = parseInt(balance, 16) / 1e18
            } catch (err) {
                console.error(err)
